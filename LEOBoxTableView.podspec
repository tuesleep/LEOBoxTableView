#
# Be sure to run `pod lib lint LEOBoxTableView.podspec' to ensure this is a
...
Simple way manage table view that have box style.
  ...
  s.homepage         = 'https://github.com/leonardo-hammer/LEOBoxTableView'
  ...
  # s.resource_bundles = {
  #   'LEOBoxTableView' => ['LEOBoxTableView/Assets/*.png']
  # }
